...
strings! {
    ...
    help_grammar_for_files => "loop over files, binding {{v}} to each path", "boucler sur des fichiers, en liant {{v}} à chaque chemin", "gennemløb filer og bind {{v}} til hver sti";
    help_grammar_for_envs => "loop over environments; BASELINE/COMPARISON to diff", "boucler sur des environnements ; BASELINE/COMPARISON pour comparer", "gennemløb miljøer; BASELINE/COMPARISON for at sammenligne";
