...
strings! {
    ...
    help_report_nodes_edit => "in the node editor: a add · e/Enter edit · f folder/fields · Del remove · Shift+↑/↓ move", "dans l'éditeur de nœuds : a ajouter · e/Entrée modifier · f dossier/champs · Suppr retirer · Maj+↑/↓ déplacer", "i node-editoren: a tilføj · e/Enter rediger · f mappe/felter · Del fjern · Skift+↑/↓ flyt";
    ...
    report_nodes_hint => "a add · e edit · f folder/fields · Del remove · Shift+↑/↓ move · n source", "a ajouter · e modifier · f dossier/champs · Suppr retirer · Maj+↑/↓ déplacer · n source", "a tilføj · e rediger · f mappe/felter · Del fjern · Skift+↑/↓ flyt · n kilde";
    ...
    report_node_show_title => "Fields:", "Champs :", "Felter:";
    report_node_show_hint => "Space toggle · Enter apply · Esc cancel", "Espace bascule · Entrée appliquer · Échap annuler", "Mellemrum skift · Enter anvend · Esc annuller";
}
