...
strings! {
    ...
    postman_key_source_label => "Where the key is kept", "Où la clé est conservée", "Hvor nøglen opbevares";
    postman_key_source_paste => "Type or paste it", "Saisie directe", "Skriv eller indsæt den";
    ...
    postman_key_source_hint => "\u{2190}/\u{2192} to change where the key comes from.", "\u{2190}/\u{2192} pour changer la provenance de la clé.", "\u{2190}/\u{2192} for at skifte, hvor nøglen kommer fra.";
    postman_key_label_op => "1Password item", "Élément 1Password", "1Password-element";
    postman_key_label_ssm => "Parameter name", "Nom du paramètre", "Parameternavn";
    postman_key_label_env => "Variable name", "Nom de la variable", "Variabelnavn";
    postman_key_hint_op => "The item\u{2019}s field, as 1Password shows it in \u{201c}Copy Secret Reference\u{201d} \u{2014} for example Private/Postman/credential. Read with the op command when the import runs; never written to disk.", "Le champ de l\u{2019}\u{e9}l\u{e9}ment, tel que 1Password l\u{2019}affiche dans \u{ab}\u{a0}Copier la r\u{e9}f\u{e9}rence secr\u{e8}te\u{a0}\u{bb} \u{2014} par exemple Private/Postman/credential. Lu avec la commande op au moment de l\u{2019}import\u{a0}; jamais \u{e9}crit sur le disque.", "Elementets felt, som 1Password viser det under \u{201c}Kopi\u{e9}r hemmelig reference\u{201d} \u{2014} for eksempel Private/Postman/credential. L\u{e6}ses med op-kommandoen, n\u{e5}r importen k\u{f8}rer; skrives aldrig til disken.";
    postman_key_hint_ssm => "The parameter\u{2019}s full name, for example /prod/postman/api-key. Read with the AWS CLI when the import runs; never written to disk.", "Le nom complet du param\u{e8}tre, par exemple /prod/postman/api-key. Lu avec l\u{2019}interface AWS au moment de l\u{2019}import\u{a0}; jamais \u{e9}crit sur le disque.", "Parameterens fulde navn, for eksempel /prod/postman/api-key. L\u{e6}ses med AWS CLI, n\u{e5}r importen k\u{f8}rer; skrives aldrig til disken.";
    postman_key_hint_env => "The name of the environment variable holding the key, for example POSTMAN_API_KEY \u{2014} not the key itself.", "Le nom de la variable d\u{2019}environnement qui contient la cl\u{e9}, par exemple POSTMAN_API_KEY \u{2014} pas la cl\u{e9} elle-m\u{ea}me.", "Navnet p\u{e5} milj\u{f8}variablen med n\u{f8}glen, for eksempel POSTMAN_API_KEY \u{2014} ikke selve n\u{f8}glen.";
