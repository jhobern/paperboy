...
strings! {
    ...
    browser_hint_collection_save => "Enter open folder · Tab file name · ← parent · type to filter · ^r reset · Esc cancel", "Entrée ouvrir dossier · Tab nom du fichier · ← dossier parent · taper pour filtrer · ^r réinitialiser · Échap annuler", "Enter åbn mappe · Tab filnavn · ← overordnet · skriv for at filtrere · ^r nulstil · Esc annuller";
    browser_hint_new_report => "Enter open folder · Tab name (use sub/name for a new folder) · type to filter · ^n scratch tab · ← up · Esc cancel", "Entrée ouvrir dossier · Tab nom (sous-dossier/nom pour créer un dossier) · taper pour filtrer · ^n onglet brouillon · ← remonter · Échap annuler", "Enter åbn mappe · Tab navn (undermappe/navn opretter en mappe) · skriv for at filtrere · ^n kladdefane · ← op · Esc annuller";
    browser_hint_workspace_save => "Enter open folder · Tab folder name · ← parent · type to filter · ^r reset · Esc cancel", "Entrée ouvrir dossier · Tab nom du dossier · ← dossier parent · taper pour filtrer · ^r réinitialiser · Échap annuler", "Enter åbn mappe · Tab mappenavn · ← overordnet · skriv for at filtrere · ^r nulstil · Esc annuller";
