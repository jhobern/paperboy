...
strings! {
    ...
    git_connect_hint => "Tab move · Enter connect · Esc cancel", "Tab naviguer · Entrée connecter · Échap annuler", "Tab flyt · Enter forbind · Esc annuller";
    ...
    postman_connect_hint => "Tab move · ←/→ key from · Enter connect · Esc cancel", "Tab naviguer · ←/→ source de la clé · Entrée connecter · Échap annuler", "Tab flyt · ←/→ nøgle fra · Enter forbind · Esc annuller";
    ...
    postman_options_hint_toggle => "Tab move · ←/→ change · Esc back", "Tab naviguer · ←/→ changer · Échap retour", "Tab flyt · ←/→ skift · Esc tilbage";
